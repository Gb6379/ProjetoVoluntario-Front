...
import { listAllpickupSpot } from "@/services/listPickupSpot";
...
const PontoColeta: React.FC = () => {
  ...
  useEffect(() => {
    const fetchpickUpSpotInfo = async () => {
      try {
        const access_token = sessionStorage.getItem('access_token');
        if (access_token) {
          const instiData = await listAllpickupSpot(access_token);//here is listAllInstitutions -> listAllInstData
